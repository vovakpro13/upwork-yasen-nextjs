  ...
  return (
    <section className="px-[16px] lg:px-32 faq-section relative" id="faq">
      ...
      <div className="flex flex-col gap-4 xl:mt-[124px] faq-wrapper-drop">
        <DropDown number={1} description={'Кои са Jmax или с какво се занимаваме и как може да помогнем?'} contant={'✅ Наша основната цел е да предоставяме изцяло персонализирани дигитални решения.\n' +
        ...
        <DropDown number={2} description={'Какво представлява безплатната Ви консултация ? '} contant={'Искаш да подобриш визията и ефективността на уеб сайта си? 👀 Имаме страхотно предложение за теб! 🔥\n' +
            '\n' +
        ...
        <DropDown number={3} description={'Искам сайт, но повечето Ваши колеги ми дадоха срок от няколко месеца ?'} contant={'Не се притеснявайте, основната причина, поради която колегите ни работят бавно е, защото превъзлагат проектите на студенти без никакъв опит.\n' +
        ...
        <DropDown number={4} description={'Каква аджеба е разликата между сайт от 500лв и от 5000лв ?'} contant={'Добър въпрос, ето и отговорът в кратко видео : https://www.instagram.com/p/CuW7AnpoQbF/\n'} />
        <DropDown number={5} description={'Издавате ли фактура ?'} contant={'Преди започване на работа подписваме договор за изработка и издаваме данъчна фактура с ДДС. В договора са описани, всички детайли по проекта, като обем работа, срокове, гаранция и други.\n'} />
      </div>
    </section>
  );
}
