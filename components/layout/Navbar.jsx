...
const Navbar = () => {
  ...
  return (
    <div
      className={`${cls} w-full fixed z-[101] wrapper-nav-global md:h-[128px] h-[80px]`}
    >
      <nav className="navbar w-full flex justify-between bg-transparent z-50 fixed overflow-hidden lg:px-32">
        <div className="left-container left-container-custom flex items-center w-[43%] lg:w-[41%] border-b-[1px] border-b-primary relative z-10">
          <Image
          ...
          <Link
            href="tel:+1234567890"
            className="tel hover-nav text-white font-montserrat font-semibold hidden lg:block top-[5px] relative"
          >
            +1 234 56 78 90
          </Link>
        </div>
        <div className="right-container right-container-header gap-2 flex justify-between w-[55%] lg:w-[58%] h-[80px] lg:h-[123px] border-b-[1px] border-b-primary relative z-10">
          ...
          <Link
            href="tel:+1234567890"
            className="mob-tel text-white w-1/2 font-montserrat lg:ml-9 mt-7 lg:mt-5 lg:font-semibold text-[10px] sm:text-lg block lg:hidden text-right whitespace-nowrap"
          >
            +1 234 56 78 90
          </Link>
